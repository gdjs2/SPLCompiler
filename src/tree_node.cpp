...
tree_node* make_tree_node(const char *name, int line_no, int is_terminate, int int_value) {
...
tree_node* make_tree_node(const char *name, int line_no, int is_terminate, float float_value) {
	tree_node *node = make_tree_node(name, line_no, is_terminate);
	// node->value = new value_node();
...
tree_node* make_tree_node(const char *name, int line_no, int is_terminate, char char_value) {
	tree_node *node = make_tree_node(name, line_no, is_terminate);
	// node->value = new value_node();
...
tree_node* make_tree_node(const char *name, int line_no, int is_terminate, bool bool_value) {
	tree_node *node = make_tree_node(name, line_no, is_terminate);
	// node->value = new value_node();
...
// tree_node* make_tree_node(const char *name, int line_no, int is_terminate, const value_node *value) {
// 	tree_node *node = make_tree_node(name, line_no, is_terminate);
// 	node->value = new value_node();
// 	memcpy(node->value, value, sizeof(value_node));
// 	return node;
// }
